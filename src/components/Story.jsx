...
function Story(){
    ...
    return(
        <section id="story" className="min-h-dvh w-full bg-black 
        text-blue-50">
            <div className="flex size-full flex-col items-center py-10 pb-24">
                ...
                <div className="-mt-80 flex w-full  justify-center md:-mt-64 md:me-44 md:justify-end">
                    <div className="flex h-full w-fit flex-col  items-center md:items-start">
                        <p className="mt-3 max-w-sm text-center font-circular-web text-violet-50 md:text-start"> Where realms converge, lies Zentry and the boundless pillar. Discover its
