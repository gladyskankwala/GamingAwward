...
function Hero() {
    ...
    const getVideoSr = (index) => `videos/hero-${index}.mp4`;

    return(
        <div className="relative h-dvh w-screen overflow-x-hidden">
            <div id="video-frame" className="relative z-10 h-dvh 
            w-screen overflow rounded-lg bg-blue-75">
                <div>
                    <div className="mask-clip-path absolute-center absolute z-50 size-64 cursor-pointer overflow-hidden rounded-lg">
                        ...
                        duration-500 ease-in hover:scale-100 hover:opacity-100">
                            <video
                            ref={nextVideoRef} 
                            src={getVideoSr(upcomingVideoIndex)}
                            loop
                            muted
                            id="current-video"
                    ...
                    <video 
                    src={getVideoSr(currentIndex === totalVideos - 1 ? 1 : currentIndex)}
                    autoPlay
                    loop
                    muted
                ...
                <div className="absolute left-0 top-0 z-40 size-full">
                    <div className="mt-24 px-5 sm:px-10">
                        ...
                        leftIcon={<TiLocation/>}
                        containerClass="!bg-yellow-300 flex-center gap1"
                        />
                    </div>
                </div>
            </div>
